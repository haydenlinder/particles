...
THREE.FlyControls = function (object, domElement) {
    ...
    this.keydown = function (event) {
        ...
        switch (event.keyCode) {
            ...
            // case 69: /*D*/ this.moveState.right = 1; break;
            ...
            case 37: /*left*/ this.moveState.rollLeft = 2; break;
            case 39: /*right*/ this.moveState.rollRight = 2; break;
        }
    ...
    this.keyup = function (event) {
        ...
        switch (event.keyCode) {
            ...
            case 87: /*W*/ clearInterval(fInc); break;
            case 83: /*S*/ clearInterval(bInc); break;
...
export default THREE.FlyControls;